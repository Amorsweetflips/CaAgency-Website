...
class TextExpander {
    ...
    destroy() {
        ...
        this.input.removeEventListener('blur-sm', this.onblur);
    }
    dismissMenu() {
        if (this.deactivate()) {
