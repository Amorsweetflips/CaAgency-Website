              ...
              <div className="flex flex-wrap gap-4">
                {talent.instagramUrl && (
                  <a
                    ...
                    className="inline-flex items-center gap-2 px-6 py-3 bg-linear-to-r from-purple-500 to-pink-500 text-white rounded-full hover:opacity-90 transition-opacity"
                  >
