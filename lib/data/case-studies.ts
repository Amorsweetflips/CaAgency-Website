...
export const caseStudies: CaseStudy[] = [
  ...
  {
    slug: 'morphe-collaboration',
    brand: 'Morphe',
    title: 'Morphe Creator Collaboration',
    vertical: 'Color Cosmetics',
    platforms: ['Instagram Reels', 'TikTok'],
    videoSrc: '/videos/work/morphe.mp4',
    summary:
      'Bold, transformation-style makeup content built around Morphe’s color range.',
    brief:
      'Morphe’s audience responds to bold looks and visible transformation. The brief called for content that showcased the range’s pigment and versatility in a format made for replays and saves.',
    approach:
      'We built the video around a full look created on camera — the format beauty audiences watch to the end. Product shots were cut into the application flow so the brand presence never interrupted the transformation.',
    outcome:
      'The campaign produced high-energy vertical content native to how makeup performs on TikTok and Reels, giving Morphe creator-authentic assets centered on its core strength: color.',
  ...
  {
    slug: 'medicube-skincare',
    brand: 'Medicube',
    title: 'Medicube K-Beauty Campaign',
    vertical: 'K-Beauty Skincare',
    platforms: ['TikTok', 'Instagram Reels'],
    videoSrc: '/videos/work/medicube.mp4',
    summary:
      'Routine-led skincare content introducing Medicube’s K-beauty devices and formulas to Western audiences.',
    brief:
      'Medicube sits at the center of the K-beauty wave, and skincare content lives or dies on believability. The brief: show the products inside a real routine, with visible skin and honest pacing, for audiences discovering Korean skincare through creators.',
    approach:
      'We drew on our Korean skincare specialism to brief the creator on what makes K-beauty content convert — texture close-ups, before/during application, and routine order. The result reads as skincare education first, promotion second.',
    outcome:
      'The campaign gave Medicube creator content tuned to how K-beauty actually spreads on social: routine-first, demonstration-heavy, and native to the for-you page.',
