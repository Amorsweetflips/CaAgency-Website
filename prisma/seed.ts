...
async function main() {
  ...
  const instagramTalents = [
    ...
    },
    {
      ...
      imageUrl: '/images/talents/beatrix-ramosaj.jpg',
      category: 'instagram',
    ...
    },
    {
      ...
      imageUrl: '/images/talents/melani-seiffert.jpg',
      category: 'instagram',
    ...
    {
      name: 'Mariya Atwani',
      imageUrl: '/images/talents/mariya-atwani.jpg',
      category: 'instagram',
    ...
    {
      name: 'Douglas Abbes',
      imageUrl: '/images/talents/douglas-abbes.jpg',
      category: 'instagram',
    ...
    {
      name: 'Khutjo Matsoma',
      imageUrl: '/images/talents/khutjo-matsoma.jpg',
      category: 'instagram',
  ...
  const talentsToDelete = [
    ...
    'Lidia Jora',
    'Anagha Sabu',
    'Saranda Mavriqi', // Not in the new list
  ]
